...
1. The Application must serve a variable amount of traffic. Most users are active during business hours. During big
...
Compute: Provision Virtual machines for application and database in multiple availability zones with auto scaling and
Azure disaster recovery to another region for failover and failback.
...
#### 4. *Log Analytics,Application Insights and Storage account*
